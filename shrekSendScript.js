async function enviarScript(scriptText) {
  ...
  if (!textarea) {
    throw new Error("Abra uma conversa no WhatsApp Web antes de executar o script.");
  }
...
// Ejecutar el script con tu mensaje
enviarScript(`
...
`).then(
  e => console.log(`Código finalizado, ${e} mensaje(s) enviado(s)`),
).catch(console.error);
